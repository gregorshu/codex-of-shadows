...
const baseTranslations = {
  en: {
    ...
    homeOngoingHeading: "Ongoing sessions",
    homeOngoingEmpty: "No ongoing sessions yet. Start a new one to see it here.",
    homeOngoingLastMessage: "Last message: {{time}}",
    homeOngoingInvestigatorLabel: "Investigator: {{name}}",
    homeOngoingShowAll: "Show all",
    ...
    cancelLabel: "Cancel",
    sendLabel: "Send",
    keeperThinking: "Keeper is thinking...",
    ...
    settingsResetTab: "Reset to defaults",
    rolePlayer: "Player",
    roleKeeper: "Keeper",
    roleSystem: "System",
...
export const translations: Record<KeeperLanguage, Record<TranslationKey, string>> = {
  ...
  ru: {
    ...
    homeOngoingHeading: "Текущие сессии",
    homeOngoingEmpty: "Пока нет текущих сессий. Начните новую, чтобы она появилась здесь.",
    homeOngoingLastMessage: "Последнее сообщение: {{time}}",
    homeOngoingInvestigatorLabel: "Следователь: {{name}}",
    homeOngoingShowAll: "Показать все",
    ...
    cancelLabel: "Отмена",
    keeperThinking: "Хранитель обдумывает ответ...",
    sendLabel: "Отправить",
    ...
    settingsResetTab: "Сбросить настройки",
    rolePlayer: "Игрок",
  ...
  fr: {
    ...
    homeOngoingHeading: "Sessions en cours",
    homeOngoingEmpty: "Aucune session en cours. Lancez-en une nouvelle pour la voir ici.",
    homeOngoingLastMessage: "Dernier message : {{time}}",
    homeOngoingInvestigatorLabel: "Investigateur : {{name}}",
    homeOngoingShowAll: "Tout afficher",
    homeOngoingShowLess: "Afficher moins",
    homeOngoingUnknownScenario: "Scénario inconnu",
    homeOngoingUnknownInvestigator: "Investigateur inconnu",
    ...
    cancelLabel: "Annuler",
    keeperThinking: "Le Gardien réfléchit...",
    sendLabel: "Envoyer",
    ...
    settingsResetTab: "Réinitialiser l'onglet",
    rolePlayer: "Joueur",
    roleKeeper: "Gardien",
    roleSystem: "Système",
  ...
  es: {
    ...
    homeOngoingHeading: "Sesiones en curso",
    homeOngoingEmpty: "Aún no hay sesiones en curso. Comienza una nueva para verla aquí.",
    homeOngoingLastMessage: "Último mensaje: {{time}}",
    homeOngoingInvestigatorLabel: "Investigador: {{name}}",
    homeOngoingShowAll: "Mostrar todo",
    homeOngoingShowLess: "Mostrar menos",
    homeOngoingUnknownScenario: "Escenario desconocido",
    homeOngoingUnknownInvestigator: "Investigador desconocido",
    ...
    keeperThinking: "El Guardián está pensando...",
    sendLabel: "Enviar",
    ...
    settingsResetTab: "Restablecer pestaña",
    rolePlayer: "Jugador",
    roleKeeper: "Guardián",
    roleSystem: "Sistema",
